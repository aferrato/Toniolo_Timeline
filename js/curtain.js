...
// rimosso perchè mette position absolute alla freccia                   $(self.options.controls).css({position:'absolute'});
                }
            }
        ...
        setEvents: function() {
            ...
            if(self.options.enableKeys) { //Rimosso per permettere l uso delle frecce destra sinistra nella timeline
